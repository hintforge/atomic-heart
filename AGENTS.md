# Atomic Heart -- Hintforge guide
<!-- v3 -- 2026-05-12 -->

This folder is a **Hintforge corpus**: a spoiler-controlled, NORA-or-Charles-flavored reference for P-3's Atomic Heart playthrough. It is data for a hint companion, **not** an agent task list.
